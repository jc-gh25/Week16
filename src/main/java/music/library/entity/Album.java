...
public class Album {
    ...
    // FIXED: Helper that keeps the inverse side consistent when the collection is set
    public void setGenres(Set<Genre> genres) {
        this.genres = genres == null ? new HashSet<>() : new HashSet<>(genres);
        // NOTE: Removed the bidirectional link management to avoid detached entity issues
        // JPA will handle the bidirectional relationship automatically during persistence
    }
